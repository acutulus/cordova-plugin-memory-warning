...
@implementation AppDelegate (memory)
...
- (AppDelegate *)swizzled_applicationDidReceiveMemoryWarning:(UIApplication*)application
{
  ...
  return [self swizzled_applicationDidReceiveMemoryWarning:application];
}
